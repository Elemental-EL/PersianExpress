...
public class CustomersMessageBoxController {
    private Stage stage;
    private Scene scene;
    @FXML
    ...
    private void ShowMessages(ArrayList<Message> messages) throws SQLException {
        mainVBox.setPrefHeight(470);
        mainPane.setPrefHeight(470);
        if (messages.size()>2){
            mainVBox.setPrefHeight(mainVBox.getPrefHeight() + 250*(messages.size() - 2));
            mainPane.setPrefHeight(mainPane.getPrefHeight() + 250*(messages.size() - 2));
        }
