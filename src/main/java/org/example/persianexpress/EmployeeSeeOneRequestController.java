...
public class EmployeeSeeOneRequestController {
    ...
    public void ShowLoanREQ(ResultSet resultSet) throws SQLException {
        ...
        while (resultSet.next()){
            ...
            Label selectAcclbl = new Label("حساب انتخاب شده :");
            Label selectAccTxt = new Label(accNum);
            Label userDiplomalbl = new Label("تحصیلات :");
            Label userDiplomaTxt = new Label(resultSet.getNString("CustomerDiploma"));
            Label userJoblbl = new Label("شغل :");
            Label userJobTxt = new Label(resultSet.getNString("CustomerJob"));
            ...
            Label SDiplomalbl = new Label("تحصیلات ضامن :");
            Label SDiplomaTxt = new Label(resultSet.getNString("SuretyDiploma"));
            Label SJoblbl = new Label("شغل ضامن :");
            Label SJobTxt = new Label(resultSet.getNString("SuretyJob"));
            Label reqDatelbl = new Label("تاریخ ثبت درخواست :");
            ...
            selectAcclbl.getStyleClass().add("labels");
            selectAccTxt.getStyleClass().add("labels");
            userDiplomalbl.getStyleClass().add("labels");
            userDiplomaTxt.getStyleClass().add("labels");
            userJoblbl.getStyleClass().add("labels");
            userJobTxt.getStyleClass().add("labels");
            ...
            SDiplomalbl.getStyleClass().add("labels");
            SDiplomaTxt.getStyleClass().add("labels");
            SJoblbl.getStyleClass().add("labels");
            SJobTxt.getStyleClass().add("labels");
            reqDatelbl.getStyleClass().add("labels");
            reqDateTxt.getStyleClass().add("labels");
            VBox vBox1 = new VBox(15);
            vBox1.setAlignment(Pos.CENTER_RIGHT);
            VBox vBox2 = new VBox(15);
            vBox1.getChildren().addAll(fullNamelbl , reqTypelbl , loanTypelbl , selectAcclbl , userDiplomalbl , userJoblbl , SfullNamelbl , SnCodelbl , SfatherNamelbl , SbDatelbl , SbPlacelbl , SphNumlbl , SDiplomalbl , SJoblbl , reqDatelbl);
            vBox2.getChildren().addAll(fullNameTxt , reqTypeTxt , loanTypeTxt , selectAccTxt , userDiplomaTxt , userJobTxt , SfullNameTxt , SnCodeTxt , SfatherNameTxt , SbDateTxt , SbPlaceTxt , SphNumTxt , SDiplomaTxt , SJobTxt , reqDateTxt);
            BorderPane borderPane = new BorderPane();
            borderPane.getStyleClass().add("CPBorderPane1");
            borderPane.setRight(vBox1);
            borderPane.setLeft(vBox2);
